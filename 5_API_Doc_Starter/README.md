...
## Getting started
The bookshelf API is a free to use API. You do not need API keys or authentication to assess the API.
The base url for this API is http://127.0.0.1 as it is currently hosted locally.
...
'''
The API will return the following errors when a requests fail:
- 400: Bad Request
